    ...
    <Modal open={Boolean(transferId)} title="Transfer details" onClose={onClose}>
      ...
      {transfer ? (
        <dl className="definition-list">
          ...
          {/* reasonCode intentionally omitted from admin UI copy when sensitive; show only safe failure text */}
          ...
          {transfer.status.startsWith('verification') ? (
            <div>
              <dt>Verification</dt>
